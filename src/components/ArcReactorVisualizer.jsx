...
export default function ArcReactorVisualizer({ state, activeGesture, handPos }) {
  ...
  useEffect(() => {
    ...
    // Twinkling Stardust & Nebular Particles
    ...
    const render = () => {
      ...
      let speedMult = 1.0;
      let primaryColor = '#a855f7'; // Cosmic Purple
      let secondaryColor = '#00f0ff'; // Quantum Cyan
      ...
      if (state === 'listening') {
        ...
        speedMult = 3.2;
        primaryColor = '#e040fb'; // Deep Magenta
      ...
      // --- 1. FULLSCREEN NEBULA SPACE WALLPAPER (ASPECT RATIO COVER FITTING) ---
      ...
      // --- 2. LIVE TWINKLING STARDUST PARTICLES OVER SPACE WALLPAPER ---
      particles.forEach(p => {
    ...
    <div style={{ width: '100%', height: '100%', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      {activeGesture && (
        <div style={{
          ...
          <Sparkles size={14} /> COSMIC BACKDROP ACTIVE: {activeGesture}
        </div>
      )}
    </div>
  );
